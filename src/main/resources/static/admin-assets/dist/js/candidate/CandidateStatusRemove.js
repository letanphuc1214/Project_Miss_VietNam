...
candidates.intTable = function () {
    ...
    $("#candidates-datatables").DataTable({
        ajax: {
            url: 'https://missvietnam.herokuapp.com/api/candidateRemoved/',
            method: 'GET',
            dataType: 'json',
            dataSrc: '',
        },
        columns: [
            ...
            },
            {
                ...
                sortable: true,
                "render": function (data) {
                    return `<span class=\"status text-danger">&bull;</span>
...
candidates.save = function () {
    if ($("#formAddEdit").valid()) {
            ...
            $.ajax({
                url: 'https://missvietnam.herokuapp.com/api/candidate/',
                method: 'PUT',
                dataType: 'json',
...
candidates.delete = function (id) {
    bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
                $.ajax({
                    url: 'https://missvietnam.herokuapp.com/api/candidate/' + id,
                    method: 'DELETE',
                    dataType: 'json',
                    success: function () {
                        $("#candidates-datatables").DataTable().ajax.reload();
...
candidates.status = function (id) {
    $.ajax({
        url: 'https://missvietnam.herokuapp.com/api/status/' + id,
        method: 'GET',
        dataType: 'json',
        success: function (data) {

           if (data.status === "Bị loại") {
                ...
                $("#candidates-datatables").DataTable().ajax.reload();
                toastr.info("Đổi sang trạng thái chờ duyệt thành công")
            }
        },
        error: function (jqXHR, exception) {
